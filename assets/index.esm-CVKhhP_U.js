 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Je{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(Ke(n)){const r=n.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(n=>n).join(" ")}}function Ke(t){const e=t.getComponent();return(e==null?void 0:e.type)==="VERSION"}const v="@firebase/app",L="0.14.11";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const u=new $e("@firebase/app"),Ye="@firebase/app-compat",Xe="@firebase/analytics-compat",qe="@firebase/analytics",Ze="@firebase/app-check-compat",Qe="@firebase/app-check",et="@firebase/auth",tt="@firebase/auth-compat",nt="@firebase/database",rt="@firebase/data-connect",st="@firebase/database-compat",it="@firebase/functions",at="@firebase/functions-compat",ot="@firebase/installations",ct="@firebase/installations-compat",lt="@firebase/messaging",ht="@firebase/messaging-compat",dt="@firebase/performance",ft="@firebase/performance-compat",ut="@firebase/remote-config",pt="@firebase/remote-config-compat",mt="@firebase/storage",gt="@firebase/storage-compat",bt="@firebase/firestore",yt="@firebase/ai",Et="@firebase/firestore-compat",_t="firebase",Dt="12.12.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ht(t){F(new w("platform-logger",e=>new Je(e),"PRIVATE")),F(new w("heartbeat",e=>new Nt(e),"PRIVATE")),S(v,L,t),S(v,L,"esm2020"),S("fire-js","")}Ht("");export{w as C,A as D,te as E,C as F,Gt as S,j as _,Vt as a,g as b,jt as c,_ as d,It as e,ae as f,Wt as g,St as h,At as i,F as j,Ut as k,E as l,Bt as m,Kt as n,Yt as o,Jt as p,Xt as q,S as r,qt as s,We as t,kt as u,Ie as v,Ce as w,xt as x,zt as y};
