...
ALTER TABLE IF EXISTS family
    ...
    ADD COLUMN IF NOT EXISTS weather_layout JSONB DEFAULT NULL;
...
ALTER TABLE IF EXISTS app_settings
    ...
    ADD COLUMN IF NOT EXISTS global_easter_enabled BOOLEAN DEFAULT TRUE,
    ADD COLUMN IF NOT EXISTS global_liquid_glass_enabled BOOLEAN DEFAULT TRUE,
    ADD COLUMN IF NOT EXISTS global_summer_enabled BOOLEAN DEFAULT TRUE;
