...
const ActivitiesPage: React.FC<ActivitiesPageProps> = ({ onProfileClick, currentLocation, liquidGlass }) => {
  ...
  return (
    <main className="p-0 pb-24">
      ...
      <div className={`sticky top-0 z-40 transition-all duration-500 overflow-hidden ${liquidGlass ? 'backdrop-blur-xl bg-white/10 border-b border-white/20 shadow-xl' : ''}`}>
