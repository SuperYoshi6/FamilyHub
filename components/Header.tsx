...
const Header: React.FC<HeaderProps> = ({ title, currentUser, onProfileClick }) => {
  return (
    <header className="sticky top-0 z-40 px-4 py-4 flex justify-between items-center transition-all duration-500 border-b shadow-sm bg-white/90 dark:bg-slate-900/90 backdrop-blur-md border-gray-100 dark:border-gray-800">
            ...
            >
              <div className="relative transition-transform duration-300 active:scale-95">
                <img 
                  ...
                  className="w-9 h-9 rounded-full border-2 shadow-sm object-cover transition-all border-white dark:border-gray-700 group-hover:ring-2 group-hover:ring-blue-200 dark:group-hover:ring-blue-800"
                />
